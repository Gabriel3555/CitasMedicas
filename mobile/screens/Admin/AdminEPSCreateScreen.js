...
const AdminEPSCreateScreen = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const result = await createEps(formData);
    setLoading(false);
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Crear Nueva EPS</Text>
...
export default AdminEPSCreateScreen;