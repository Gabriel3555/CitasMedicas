  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Animatable.View animation="fadeInUp" duration={800} delay={200} style={styles.actionsContainer}>
        <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate('ScheduleAppointment')}>
          <Text style={styles.actionButtonText}>📅 Agendar Cita</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate('CitasList')}>
